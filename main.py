...
def insert_marks(assessments, student_id):
    ...
    while True:
        ...
        assessment_info = {"subject_code": subject_code,
                           "assessment_number": assessment_number,
                           "marks": marks}
        assessments.write(f"{student_id}\t")    
        for value in assessment_info.values():
            assessments.write(value)
            assessments.write('\t')
        assessments.write('\n')
        ...
        new_record = input("Do you want to enter marks for another assessment (Y/N)?\n= ")
        if new_record.capitalize() == "N":
            break
    return 1
...
def search_marks(students, assessments, student_id):
    ...
    for student in student_list:
        ...
        if s_id == student_id:
            ...
            student_info['Course'] = student.split('\t')[2]
    ...
    for assessment in assessments_list:
        ...
        if assessment_split[0] == student_id:
            ...
            assessment_dict['Marks'] = assessment_split[3]
...
if __name__ == "__main__":
    QUIT = False
    OPTIONS = ["Welcome to the student and Assessment management system.",
        ...
        while not QUIT:
            ...
            if user_input.capitalize() == "Q":
                ...
                while True:
                    ...
                    new_record = input("Do you want to enter details for another student (Y/N)?\n= ")
                    if new_record.capitalize() == "N":
                        break
            elif user_input.capitalize() == "I":
                student_id = input(f"{common_request_string} student ID: ")
                ...
                while True:
                    ...
                    for item in assessments_info:
                        print(item[subject_code] + ' ' * (len(subject_code) - len(item[subject_code])) + '\t' 
                              + item[assessment_number] + ' ' * (len(assessment_number) - len(item[assessment_number])) + '\t' 
                              + item['Marks'])
                    new_search = input("Do you want to search assessment marks for another student (Y/N)?\n= ")
                    if new_search.capitalize() == "N":
                        break
            else:
